...
export default function ServiceDetailsView() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="mb-6">
        <div className="bg-yellow-500 text-white font-medium py-3 px-6 rounded-md text-center text-lg">
          Servicio pendiente
        </div>
      </div>
      
      <div className="flex flex-col md:flex-row gap-6">
        {/* Left column with image and chat section */}
        <div className="w-full md:w-1/2 flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center">
            <h3 className="text-purple-700 text-xl font-medium mb-1">¿Tienes dudas?</h3>
            <p className="text-gray-600 mb-3">Contacta con tu profesionista</p>
            <button className="bg-blue-400 hover:bg-blue-500 text-white py-2 px-6 rounded-md transition-colors">
